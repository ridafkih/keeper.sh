...
## Why a sync engine needs a memory
...
## How a change gets noticed without re-reading everything
...
## Why a deleted event is the easiest one to miss
...
## How we tell a real change from the same event twice
...
## What stops two mirrored calendars flooding each other
...
## What the clocks changing does to a repeating event
...
## Why deleting is the dangerous half of the job
