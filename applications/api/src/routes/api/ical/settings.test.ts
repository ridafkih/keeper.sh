...
import type { handlePatchIcalSettingsRoute as handlePatchIcalSettingsRouteFn } from "./settings";
...
beforeAll(async () => {
  ...
  ({ handlePatchIcalSettingsRoute } = await import("./settings"));
});
