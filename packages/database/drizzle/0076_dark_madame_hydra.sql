...
CREATE INDEX "event_mappings_event_state_idx" ON "event_mappings" USING btree ("eventStateId");--> statement-breakpoint
CREATE INDEX "event_mappings_missing_sync_event_idx" ON "event_mappings" USING btree ("id") WHERE "event_mappings"."syncEventId" is null;--> statement-breakpoint
