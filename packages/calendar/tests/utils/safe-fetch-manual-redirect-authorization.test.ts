...
const serveWellKnownRedirect = (): void => {
...
describe("credentials across a caller-followed well-known redirect", () => {
  it("never sends the CalDAV password to the host the discovery redirect points at", async () => {
    serveWellKnownRedirect();
