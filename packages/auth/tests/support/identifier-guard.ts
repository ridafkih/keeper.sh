...
const remediationTestFiles = () => [
  ...
  "packages/calendar/tests/core/deletion/a-deferred-residue-pass-does-not-spend-a-repair-attempt.test.ts",
  ...
  "packages/calendar/tests/core/deletion/a-grant-blocked-by-an-unknowable-credential-is-not-retired-unrevoked.test.ts",
  "packages/calendar/tests/core/deletion/a-grant-is-not-revoked-while-that-user-has-unreaped-push-residue-outside-the-batch.test.ts",
  "packages/calendar/tests/core/deletion/a-grant-retired-without-revocation-is-reported-not-silently-dropped.test.ts",
  "packages/calendar/tests/core/deletion/a-permanently-failing-residue-repair-retires-at-its-attempt-cap.test.ts",
  "packages/calendar/tests/core/deletion/an-abandoned-repair-cancels-the-in-flight-grant-revocation.test.ts",
  "packages/calendar/tests/core/deletion/an-abandoned-residue-repair-never-revokes-the-grant.test.ts",
  "packages/calendar/tests/core/deletion/expired-oauth-grant-residue-is-retired-instead-of-retried-forever.test.ts",
  "packages/calendar/tests/core/deletion/grant-residue-resolves-its-own-provider-identity.test.ts",
  ...
  "packages/calendar/tests/core/deletion/residue-identity-resolution-is-cancelled-on-the-repair-deadline.test.ts",
  ...
  "packages/calendar/tests/core/utils/tombstone-provisional-branch-reprobes-the-user-row.test.ts",
  ...
  "services/api/tests/utils/a-vanished-credential-row-stays-a-409-even-when-the-refresh-token-rotated.test.ts",
  ...
  "services/api/tests/utils/connect-recovers-from-a-concurrent-account-identity-claim.test.ts",
  "services/api/tests/utils/connect-refresh-adopts-a-late-landing-rotation.test.ts",
  "services/api/tests/utils/connect-refresh-cancellation-records-the-rotation-loss.test.ts",
  "services/api/tests/utils/connect-refresh-raises-needs-reauthentication-on-a-revoked-grant.test.ts",
  "services/api/tests/utils/connect-refresh-request-outlives-the-connect-deadline.test.ts",
  "services/api/tests/utils/connect-userinfo-401-flags-the-revoked-grant-for-reauthentication.test.ts",
  "services/api/tests/utils/connect-writes-the-revoked-grant-flag-onto-an-existing-calendar-account.test.ts",
  "services/api/tests/utils/credential-adoption-update-that-touched-no-row-reissues-the-grant.test.ts",
  ...
  "services/api/tests/utils/grant-census-is-emitted-on-every-path-that-lets-the-delete-proceed.test.ts",
  "services/api/tests/utils/grant-census-runs-after-push-channel-deregistration.test.ts",
  "services/api/tests/utils/grants-revoked-only-after-the-delete-commits.test.ts",
  "services/api/tests/utils/oauth-grant-residue-carries-the-credential-expiry.test.ts",
  "services/api/tests/utils/oauth-grant-residue-carries-the-provider-account-id.test.ts",
  "services/api/tests/utils/oauth-grant-residue-does-not-outlive-the-delete-that-crashed.test.ts",
  "services/api/tests/utils/oauth-grant-residue-records-the-google-account.test.ts",
  "services/api/tests/utils/outlook-userinfo-401-flags-the-connected-account-for-reauthentication.test.ts",
  "services/api/tests/utils/push-channel-residue-capture-issues-its-records-concurrently.test.ts",
  "services/api/tests/utils/push-channel-residue-survives-a-deregistration-that-stopped-nothing.test.ts",
  ...
  "services/api/tests/utils/residue-refuses-a-fabricated-calendar-account-id-as-a-provider-identity.test.ts",
  ...
  "services/cron/tests/jobs/a-renamed-account-email-does-not-make-a-surviving-grant-revocable.test.ts",
  ...
  "services/cron/tests/jobs/census-repair-attempts-a-bounded-number-of-rows-per-pass.test.ts",
  "services/cron/tests/jobs/census-repair-attempts-a-reauth-flagged-blocking-credential.test.ts",
  "services/cron/tests/jobs/census-repair-stops-when-its-time-budget-is-spent.test.ts",
  ...
  "services/cron/tests/jobs/reaper-repairs-the-credentials-that-stall-the-census.test.ts",
