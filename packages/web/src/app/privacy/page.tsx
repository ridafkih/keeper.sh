      ...
      <div className="text-sm text-foreground-secondary flex flex-col gap-8">
        <section className="flex flex-col gap-3">
          ...
          <p>
            ...
            and safeguard your information when you use our calendar
            synchronization service.
          </p>
          <p>
            By using Keeper, you consent to the data practices described in this
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            ...
            authentication credentials. If you sign up using a third-party
            provider (such as Google), we receive basic profile information as
          ...
          <p>
            To provide our service, we access calendar data from sources you
            connect. This includes event titles, times, durations, and
            associated metadata. We only access calendars you explicitly
            authorize.
          </p>
          ...
          <p>
            ...
            access times, and pages viewed. This data helps us improve our
        ...
        <section className="flex flex-col gap-3">
          ...
          <ul className="list-disc list-inside flex flex-col gap-1 ml-2">
            ...
            <li>
              Aggregate and anonymize calendar events for shared feeds, showing
              only busy/free status
            </li>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            A core feature of Keeper is event anonymization. When you generate a
            shared iCal feed or push to external calendars, event details
            (titles, descriptions, attendees, locations) are stripped. Only
            busy/free time blocks are shared, protecting the privacy of your
            schedule details.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            Calendar data is cached temporarily to enable synchronization and is
            refreshed according to your plan's sync interval. We do not retain
            historical calendar data beyond what is necessary for the service to
            function.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            We retain your account information and calendar data for as long as
            your account is active. When you delete your account, we delete all
            associated data within 30 days, except where retention is required
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            We integrate with third-party calendar providers (such as Google
            Calendar) to access and sync your calendar data. These integrations
            are governed by the respective providers' terms and privacy
            policies. We only request the minimum permissions necessary to
            provide our service.
          </p>
          <p>
            We use third-party services for payment processing (Polar). Payment
            information is handled directly by these processors and is not
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            Keeper is not intended for use by individuals under the age of 13.
