      ...
      <div className="text-sm text-foreground-secondary flex flex-col gap-8">
        <section className="flex flex-col gap-3">
          ...
          <p>
            ...
            agreement between you and Keeper ("we", "our", or "us") governing
            your access to and use of the Keeper calendar synchronization
            service.
          </p>
          <p>
            By accessing or using Keeper, you agree to be bound by these Terms.
            If you disagree with any part of these Terms, you may not access or
            use the service.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            Keeper provides calendar aggregation and synchronization services
            that allow you to combine events from multiple calendar sources into
            a unified, anonymized feed. The service includes generating iCal
            feeds and pushing events to external calendar providers.
          </p>
          <p>
            We reserve the right to modify, suspend, or discontinue any aspect
            of the service at any time, with or without notice. We shall not be
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            To use Keeper, you must create an account. You agree to provide
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            Keeper offers both free and paid subscription plans. Paid
          ...
          <p>
            We may change subscription fees upon reasonable notice. Continued
            use of the service after a price change constitutes acceptance of
            the new fees. You may cancel your subscription at any time; access
        ...
        <section className="flex flex-col gap-3">
          ...
          <ul className="list-disc list-inside flex flex-col gap-1 ml-2">
            ...
            <li>
              Use the service to transmit malicious code or engage in abusive
              behavior
            </li>
          </ul>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            ...
            are owned by Keeper and are protected by international copyright,
            trademark, and other intellectual property laws.
          </p>
          <p>
            Keeper is open-source software licensed under the GPL-3.0 license.
            ...
            . Your use of the source code is governed by the terms of that
            license.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            You retain ownership of any calendar data and content you provide to
            the service. By using Keeper, you grant us a limited license to
            access, process, and display your content solely as necessary to
            provide the service.
          </p>
          <p>
            You represent that you have the right to share any calendar data you
            connect to Keeper and that doing so does not violate any third-party
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            Keeper integrates with third-party calendar providers and services.
            Your use of these integrations is subject to the terms and policies
            of those third parties. We are not responsible for the practices of
            third-party services.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL KEEPER, ITS
          ...
          <p>
            ...
            SERVICE SHALL NOT EXCEED THE AMOUNT YOU PAID US, IF ANY, DURING THE
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            You agree to indemnify and hold harmless Keeper and its officers,
            directors, employees, and agents from any claims, damages, losses,
            or expenses (including reasonable attorneys' fees) arising from your
            use of the service, violation of these Terms, or infringement of any
            third-party rights.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            ...
            the service settings. Provisions of these Terms that by their nature
        ...
        <section className="flex flex-col gap-3">
          ...
          <p>
            ...
            the laws of the jurisdiction in which Keeper operates, without
