...
const features: Feature[] = [
  {
    ...
    description:
      "Combine events from multiple calendar sources into a single unified feed.",
  },
  {
    icon: EyeOff,
  ...
  },
  {
    ...
    description:
      "Generate a shareable iCal link that stays in sync with your sources.",
  },
  {
    icon: Upload,
    title: "Push to Calendars",
    description:
      "Automatically push aggregated events to Google Calendar and others.",
  },
  {
    icon: Server,
    title: "Self-Hostable",
    description:
      "Run it on your own infrastructure. Fully open-source and GPL-3.0 licensed.",
  },
];
