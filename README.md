...
| ENCRYPTION_KEY                 | `api`, `cron`, `worker` | Required for `api` and `cron`. Key for encrypting CalDAV credentials and account-deletion residue at rest.<br><br>e.g. `openssl rand -base64 32`                     |
