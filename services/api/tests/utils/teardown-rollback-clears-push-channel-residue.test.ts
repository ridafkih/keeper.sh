...
describe("a rolled back delete clears push channel residue, not only oauth grant residue", () => {
  it("leaves no residue of any kind behind for a user who was never deleted", async () => {
